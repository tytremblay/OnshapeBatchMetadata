...
namespace Onshape.Api
{
    public class OnshapeClient
    {
        ...
        public async Task<OnshapePartMetadata> GetPartMetadata(String documentId, String wvm, String wvmId, String elementId, String partId)
        {
            return await HttpGet<OnshapePartMetadata>(String.Format(Constants.EXPORT_PART_API_URI, documentId, wvm, wvmId, elementId, partId, "metadata"));
        }

        public async Task<OnshapePartMetadata> UpdateWorkspacePartMetadata(String documentId, String workspaceId, OnshapePartMetadata partMetadata)
        {
            return await HttpPost<OnshapePartMetadata>(String.Format(Constants.EXPORT_PART_API_URI, documentId, "w", workspaceId, partMetadata.elementId, partMetadata.partId, "metadata"), partMetadata);
        }
